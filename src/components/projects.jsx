...
import {openProject, closeProject} from '../redux/actions'
    ...
    return (
      <main>
        ...
        <div className='projects-wrapper clearfix'>
          <Project title="Boids" summary="GPU Flocking simulation written in CUDA which easily handles half a million agents at 60fps+" thumbnail={require('../public/img/boids.gif')} thumbnail-hq={require('../public/img/boids.gif')} repo='//github.com/austinEng/Project1-CUDA-Flocking'>
            <h2>Introduction</h2>
            ...
            <div className='media'>
              <img src={require('../public/img/boids.gif')} />
            </div>
            ...
            <div className='media'>
              <img src={require('../public/img/particleCount_vs_msframe.png')} />
            </div>
            ...
            <div className='media'>
              <img src={require('../public/img/particleCount_vs_msframe_fine.png')} />
            </div>
            ...
            <div className='media'>
              <img src={require('../public/img/blockSize_vs_relative_msframe.png')} />
            </div>
          ...
          <Project title="BioCrowds" summary="Realtime, 60fps+, WebGL crowd navigation inspired by spatial colonization algorithms and implemented with shaders" thumbnail={require('../public/img/biocrowds.png')} thumbnail-hq={require('../public/img/biocrowds.gif')} repo='//github.com/austinEng/CrowdsJS'>
            ...
            <div className='media'>
              <video src={require('../public/img/biocrowds.webm')} controls autoPlay loop></video>
            </div>
          ...
          <Project title="FLIP/PIC Fluid Solver" summary="Highly concurrent C++ fluid solver capable of simulating over one million particles" thumbnail={require('../public/img/flip.png')} thumbnail-hq={require('../public/img/flip.gif')} repo='//github.com/austinEng/FLIP-PIC-Fluid-Solver'>
            <h2>Introduction</h2>
          ...
          <Project title="Monte Carlo Pathtracer" summary="C++ Monte Carlo pathtracer build from scratch. Supports multiple importance sampling, progressive rendering, sobol quasi-random sampling, and BVH acceleration" thumbnail={require("../public/img/renders/dragon_blinn_64spp_12min_BVHbuild_23sec.bmp")}>
            <h2>Introduction</h2>
              ...
              <div className='image-row clearfix'>
                <div className='captioned-image'>
                  <img src={require('../public//img/renders/dragon_mirror_64spp_15min_BVHbuild_17sec.bmp')} />
                  <div className="caption">
                    Cornell box with Stanford dragon and Stanford bunny featuring mirror materials
                  </div>
                </div>
                <div className='captioned-image'>
                  <img src={require('../public//img/renders/refractive_spheres_64spp_3min.bmp')} />
                  <div className="caption">
                    Cornell box featuring refractive spheres and caustic effects
                  </div>
                </div>
                <div className='captioned-image'>
                  <img src={require('../public//img/renders/various_materials_64spp_3min.bmp')} />
                    <div className="caption">
                      Cornell box with objects of various materials
                    </div>
                </div>
                <div className='captioned-image'>
                  <img src={require('../public//img/renders/bunny.bmp')} />
                    <div className="caption">
            ...
            <div className='image-row clearfix'>
              <div className='captioned-image' style={{'width': '33%'}}>
                <img src={require('../public//img/renders/light_only.bmp')} />
                <div className="caption">
                  Light sampling only
                </div>
              </div>
              <div className='captioned-image' style={{'width': '33%'}}>
                <img src={require('../public//img/renders/veach_64spp_5min.bmp')} />
                <div className="caption">
                  Multiple Importance Sampling
                </div>
              </div>
              <div className='captioned-image' style={{'width': '33%'}}>
                <img src={require('../public//img/renders/brdf_only.bmp')} />
                  <div className="caption">
                    BRDF sampling only
                  </div>
              </div>
            ...
            <div className='image-row clearfix'>
              <div className='captioned-image' style={{'width': '50%'}}>
                <img src={require('../public//img/bvh/dragon.png')} />
                <div className="caption">
                  Stanford Dragon
                </div>
              </div>
              <div className='captioned-image' style={{'width': '50%'}}>
                <img src={require('../public//img/bvh/bvh.png')} />
                <div className="caption">
            ...
            <div className='image-row clearfix'>
              <div className='captioned-image'>
                <a href={require("../public/img/bvh/teapot_c10_b0.042409_t0.000211633.png")}><img src={require("../public/img/bvh/teapot_c10_b0.042409_t0.000211633.jpg")} /></a>
            		<div className="caption">
            			Cluster Size: 10<br />
              ...
              <div className='captioned-image'>
                <a href={require("../public/img/bvh/teapot_c100_b0.089652_t0.000107177.png")}><img src={require("../public/img/bvh/teapot_c100_b0.089652_t0.000107177.jpg")} /></a>
            		<div className="caption">
            			Cluster Size: 100<br />
              ...
              <div className='captioned-image'>
                <a href={require("../public/img/bvh/teapot_c1000_b0.417885_t8.54407e-05.png")}><img src={require("../public/img/bvh/teapot_c1000_b0.417885_t8.54407e-05.jpg")} /></a>
            		<div className="caption">
              ...
              <div className='captioned-image'>
                <a href={require("../public/img/bvh/teapot_c10000_b0.573137_t9.54002e-05.png")}><img src={require("../public/img/bvh/teapot_c10000_b0.573137_t9.54002e-05.jpg")} /></a>
            		<div className="caption">
            ...
            <div className='image-row clearfix'>
              <div className='captioned-image'>
                <a href={require("../public/img/bvh/bunny_low_c10_b0.137205_t0.00106669.png")}><img src={require("../public/img/bvh/bunny_low_c10_b0.137205_t0.00106669.jpg")} /></a>
            		<div className="caption">
            			Cluster Size: 10<br />
              ...
              <div className='captioned-image'>
                <a href={require("../public/img/bvh/bunny_low_c100_b0.451929_t0.000328793.jpg")}><img src={require("../public/img/bvh/bunny_low_c100_b0.451929_t0.000328793.jpg")} /></a>
            		<div className="caption">
            			Cluster Size: 100<br />
              ...
              <div className='captioned-image'>
                <a href={require("../public/img/bvh/bunny_low_c1000_b1.96188_t0.000149602.png")}><img src={require("../public/img/bvh/bunny_low_c1000_b1.96188_t0.000149602.jpg")} /></a>
            		<div className="caption">
            			Cluster Size: 1000<br />
              ...
              <div className='captioned-image'>
                <a href={require("../public/img/bvh/bunny_low_c10000_b9.2727_t0.000120217.png")}><img src={require("../public/img/bvh/bunny_low_c10000_b9.2727_t0.000120217.jpg")} /></a>
            		<div className="caption">
            			Cluster Size: 10000<br />
            ...
            <div className='image-row clearfix'>
              <div className='captioned-image'>
                <a href={require("../public/img/bvh/dragon_c10_b2.24062_t0.0196656.png")}><img src={require("../public/img/bvh/dragon_c10_b2.24062_t0.0196656.jpg")} /></a>
            		<div className="caption">
            			Cluster Size: 10<br />
              ...
              <div className='captioned-image'>
                <a href={require("../public/img/bvh/dragon_c100_b9.64125_t0.00198559.png")}><img src={require("../public/img/bvh/dragon_c100_b9.64125_t0.00198559.jpg")} /></a>
            		<div className="caption">
            			Cluster Size: 100<br />
              ...
              <div className='captioned-image'>
                <a href={require("../public/img/bvh/dragon_c1000_b46.9278_t0.000392493.png")}><img src={require("../public/img/bvh/dragon_c1000_b46.9278_t0.000392493.jpg")} /></a>
            		<div className="caption">
            			Cluster Size: 1000<br />
              ...
              <div className='captioned-image'>
                <a href={require("../public/img/bvh/dragon_c10000_b385.871_t0.000161021.png")}><img src={require("../public/img/bvh/dragon_c10000_b385.871_t0.000161021.jpg")} /></a>
            		<div className="caption">
            			Cluster Size: 10000<br />
            ...
            <div className='image-row clearfix'>
              <div className='captioned-image' style={{'margin': 'auto', 'width': '75%', 'float': 'none'}}>
                <a href={require("../public/img/bvh/dragon_c100000_b4513.11_t0.000128856.png")}><img src={require("../public/img/bvh/dragon_c100000_b4513.11_t0.000128856.jpg")} /></a>
            		<div className="caption">
          ...
          <Project title="Mini Maya" summary="A mini 3D modeling program built as an introduction to the fundamentals of computer graphics" thumbnail={require("../public/img/minimaya/test-render.bmp")}>
            <h2>Introduction</h2>
            ...
            <div className='media'>
              <img src={require('../public/img/minimaya/transformation-controls.gif')} />
            </div>
            ...
            <div className='media'>
              <img src={require('../public/img/minimaya/mesh-editing.gif')} />
            </div>
            ...
            <div className='media'>
              <img src={require('../public/img/minimaya/scene-graph.gif')} />
            </div>
            ...
            <div className='media'>
              <img src={require('../public/img/minimaya/material-editing.gif')} />
            </div>
            ...
            <div className='media'>
              <img src={require('../public/img/minimaya/bvh.gif')} />
            </div>
            ...
            <div className='media'>
              <img src={require("../public/img/minimaya/test-render.bmp")} />
            </div>
